...
const (
	Connection_CONNECTION_TYPE_UNSPECIFIED Connection_Type = 0
...
type Connection struct {
	...
	Start *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=start,proto3" json:"start,omitempty"`
	End   *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=end,proto3" json:"end,omitempty"`
	Type  Connection_Type        `protobuf:"varint,4,opt,name=type,proto3,enum=coder.agent.v2.Connection_Type" json:"type,omitempty"`
}
...
func (x *Connection) GetStart() *timestamppb.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *Connection) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x22, 0x94, 0x02, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x22, 0x61, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x1b,
	...
	0x47, 0x5f, 0x50, 0x54, 0x59, 0x10, 0x04, 0x22, 0x55, 0x0a, 0x17, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	0x6f, 0x6e, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x63,
	...
	0x59, 0x10, 0x04, 0x32, 0xc4, 0x08, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x4b, 0x0a,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x53, 0x0a, 0x10, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x43,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x63, 0x6f, 0x64, 0x65,
...
var file_agent_proto_agent_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(Connection_Type)(0),                          // 9: coder.agent.v2.Connection.Type
	(*WorkspaceApp)(nil),                          // 10: coder.agent.v2.WorkspaceApp
	(*WorkspaceAgentScript)(nil),                  // 11: coder.agent.v2.WorkspaceAgentScript
	(*WorkspaceAgentMetadata)(nil),                // 12: coder.agent.v2.WorkspaceAgentMetadata
	(*Manifest)(nil),                              // 13: coder.agent.v2.Manifest
	(*GetManifestRequest)(nil),                    // 14: coder.agent.v2.GetManifestRequest
	(*ServiceBanner)(nil),                         // 15: coder.agent.v2.ServiceBanner
	(*GetServiceBannerRequest)(nil),               // 16: coder.agent.v2.GetServiceBannerRequest
	(*Stats)(nil),                                 // 17: coder.agent.v2.Stats
	(*UpdateStatsRequest)(nil),                    // 18: coder.agent.v2.UpdateStatsRequest
	(*UpdateStatsResponse)(nil),                   // 19: coder.agent.v2.UpdateStatsResponse
	(*Lifecycle)(nil),                             // 20: coder.agent.v2.Lifecycle
	(*UpdateLifecycleRequest)(nil),                // 21: coder.agent.v2.UpdateLifecycleRequest
	(*BatchUpdateAppHealthRequest)(nil),           // 22: coder.agent.v2.BatchUpdateAppHealthRequest
	(*BatchUpdateAppHealthResponse)(nil),          // 23: coder.agent.v2.BatchUpdateAppHealthResponse
	(*Startup)(nil),                               // 24: coder.agent.v2.Startup
	(*UpdateStartupRequest)(nil),                  // 25: coder.agent.v2.UpdateStartupRequest
	(*Metadata)(nil),                              // 26: coder.agent.v2.Metadata
	(*BatchUpdateMetadataRequest)(nil),            // 27: coder.agent.v2.BatchUpdateMetadataRequest
	(*BatchUpdateMetadataResponse)(nil),           // 28: coder.agent.v2.BatchUpdateMetadataResponse
	(*Log)(nil),                                   // 29: coder.agent.v2.Log
	(*BatchCreateLogsRequest)(nil),                // 30: coder.agent.v2.BatchCreateLogsRequest
	(*BatchCreateLogsResponse)(nil),               // 31: coder.agent.v2.BatchCreateLogsResponse
	(*GetAnnouncementBannersRequest)(nil),         // 32: coder.agent.v2.GetAnnouncementBannersRequest
	(*GetAnnouncementBannersResponse)(nil),        // 33: coder.agent.v2.GetAnnouncementBannersResponse
	(*BannerConfig)(nil),                          // 34: coder.agent.v2.BannerConfig
	(*WorkspaceAgentScriptCompletedRequest)(nil),  // 35: coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	(*WorkspaceAgentScriptCompletedResponse)(nil), // 36: coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	(*Timing)(nil),                                // 37: coder.agent.v2.Timing
	(*Connection)(nil),                            // 38: coder.agent.v2.Connection
	(*ReportConnectionRequest)(nil),               // 39: coder.agent.v2.ReportConnectionRequest
	(*WorkspaceApp_Healthcheck)(nil),              // 40: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),         // 41: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),    // 42: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 43: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 44: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 45: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 46: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil), // 47: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*durationpb.Duration)(nil),                      // 48: google.protobuf.Duration
	(*proto.DERPMap)(nil),                            // 49: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	40, // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,  // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	48, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	41, // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	42, // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	43, // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	49, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	11, // 8: coder.agent.v2.Manifest.scripts:type_name -> coder.agent.v2.WorkspaceAgentScript
	10, // 9: coder.agent.v2.Manifest.apps:type_name -> coder.agent.v2.WorkspaceApp
	42, // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	44, // 11: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	45, // 12: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	17, // 13: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	48, // 14: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 15: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	50, // 16: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	20, // 17: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	47, // 18: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	5,  // 19: coder.agent.v2.Startup.subsystems:type_name -> coder.agent.v2.Startup.Subsystem
	24, // 20: coder.agent.v2.UpdateStartupRequest.startup:type_name -> coder.agent.v2.Startup
	41, // 21: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	26, // 22: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	50, // 23: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	6,  // 24: coder.agent.v2.Log.level:type_name -> coder.agent.v2.Log.Level
	29, // 25: coder.agent.v2.BatchCreateLogsRequest.logs:type_name -> coder.agent.v2.Log
	34, // 26: coder.agent.v2.GetAnnouncementBannersResponse.announcement_banners:type_name -> coder.agent.v2.BannerConfig
	37, // 27: coder.agent.v2.WorkspaceAgentScriptCompletedRequest.timing:type_name -> coder.agent.v2.Timing
	50, // 28: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	50, // 29: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	...
	50, // 32: coder.agent.v2.Connection.start:type_name -> google.protobuf.Timestamp
	50, // 33: coder.agent.v2.Connection.end:type_name -> google.protobuf.Timestamp
	9,  // 34: coder.agent.v2.Connection.type:type_name -> coder.agent.v2.Connection.Type
	38, // 35: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	48, // 36: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	50, // 37: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	48, // 38: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	48, // 39: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 40: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	46, // 41: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 42: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	14, // 43: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	16, // 44: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	18, // 45: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	21, // 46: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	22, // 47: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	25, // 48: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	27, // 49: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	30, // 50: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	32, // 51: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	35, // 52: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	39, // 53: coder.agent.v2.Agent.ReportConnection:input_type -> coder.agent.v2.ReportConnectionRequest
	13, // 54: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	15, // 55: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	19, // 56: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	20, // 57: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	23, // 58: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	24, // 59: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	28, // 60: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	31, // 61: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	33, // 62: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	36, // 63: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	51, // 64: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
